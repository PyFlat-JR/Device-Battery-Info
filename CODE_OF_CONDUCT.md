...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by messaging the
maintainer directly on Discord (`anonym_2546`). All complaints will be reviewed and investigated
promptly and fairly.
...
2. **Warning** - A warning with consequences for continued behavior, including a temporary ban from
